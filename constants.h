...
#define MAX_QUESTIONS 5       // Massimo numero di domande per tema
#define BUFFER_SIZE 512       // Dimensione massima del buffer per i messaggi
#define MAX_NICKNAME_LEN 50   // Lunghezza massima del nickname
